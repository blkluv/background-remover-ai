    ...
    <section>
        ...
        <div>
            ...
            <p class="max-w-2xl mt-4 text-lg tracking-tight text-gray-600">
                If you have other questions, please contact us at info@arvrtise.com
            </p>
            </div>
        </div>
        <div class="w-full mx-auto mt-8 text-left">
            ...
            <div class="p-4 mx-auto lg:max-w-7xl lg:p-0">
                ...
                <li>
                    ...
                    <div class="mt-2 text-base text-gray-500">
                    Yes, we have a refund policy in place for cases where customers encounter issues with our service. If you experience any difficulties or have concerns, please reach out to our dedicated support team at info@arvrtise.com 
                    </div>
                </li>
                <li>
                    <div>
